...
#define SHAPE_SIMD "sse.inl"
//! #define SHAPE_SIMD "off.inl"
//! #define SHAPE_SIMD "arm.inl"
...
namespace shape
{
	...
	struct base_vtx
	{
		struct pos_t { real3 v; };
		struct nor_t { half4 v[2]; };
		struct tex_t { half2 v[2]; };
		struct skn_t { byte4 v[2]; };
	};
