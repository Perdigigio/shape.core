#ifndef SHAPE_CORE_VIDEO_D3D11_BASEMODEL_HH__GUARD
#define SHAPE_CORE_VIDEO_D3D11_BASEMODEL_HH__GUARD
...
namespace shape
{
	namespace video
	{
		template<class Concrete> class CoreVideoBaseModel
		{
		public:
			...
			inline CoreVideoBaseModel(D3D11Device p_device, ULONG p_length)
			{
		...
		// template<class Concrete> void CoreVideoBaseModel<Concrete>::upload(D3D11DeviceContext p_context)
		// {
		...
		template<class Concrete> void CoreVideoBaseModel<Concrete>::attach(D3D11DeviceContext p_context)
		{
		...
		template<class Concrete> void CoreVideoBaseModel<Concrete>::detach(D3D11DeviceContext p_context)
		{
			ID3D11Buffer * const l_buffers[] =
			{
				nullptr,
