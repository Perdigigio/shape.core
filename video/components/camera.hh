#ifndef SHAPE_VIDEO_COMPONENTS_CAMERA_HH__GUARD
#define SHAPE_VIDEO_COMPONENTS_CAMERA_HH__GUARD
...
namespace shape
{
	...
	class cComponentsCamera : private camera
	{
		inline cComponentsCamera() noexcept
		{
