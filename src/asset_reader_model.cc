...
namespace shape
{
	...
	static inline bool is_pos(const details::body_buffer &p_buf) { return p_buf.fmt == model_buffer_name::pos; }
	static inline bool is_idx(const details::body_buffer &p_buf) { return p_buf.fmt == model_buffer_name::idx; }
	static inline bool is_nor(const details::body_buffer &p_buf) { return p_buf.fmt == model_buffer_name::nor || !p_buf.fmt; }
	static inline bool is_tex(const details::body_buffer &p_buf) { return p_buf.fmt == model_buffer_name::tex || !p_buf.fmt; }
	static inline bool is_skn(const details::body_buffer &p_buf) { return p_buf.fmt == model_buffer_name::skn || !p_buf.fmt; }
